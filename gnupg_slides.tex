...
\usepackage[toc,highlight,DFKI]{HA-prosper}
\usepackage{latabbr}
\usepackage{verbatim}
...
%\newrgbcolor{}{.19 .44 .61}
%\newcommand{\highlight}[1]{\textbf{\selectfont\red#1}}
%\newcommand{\gppoutput}[1]{\flushright{\selectfont\red$\bf\Longrightarrow$}~~~\texttt{#1}}
%\newcommand{\gppmacro}[1]{\texttt{\##1}}
%\newcommand{\gpparg}[1]{\texttt{\textit{#1}}}
...
\author{%
  ...
  \institution{Erwin-Schr\"odinger-Stra{\ss}e 57}\\
  \institution{67663 Kaiserslautern}\\
  \email{\url{tristan.miller@dfki.de}}
}
\HAPsetup{rf={Introduction to GnuPG --- \today},lf={\copyright\,2004 DFKI GmbH}}
...
\begin{slide}{Generating a new keypair}
...
\begin{slide}[toc=]{Generating a new keypair}
...
\begin{slide}{Your public keyring}
...
\makeatletter\renewcommand{\verbatim@font}{\tiny\tt}\makeatother
\begin{slide}{Generating a revocation certificate}
...
\makeatletter\renewcommand{\verbatim@font}{\scriptsize\tt}\makeatother
\begin{slide}{Exporting a public key}
...
\begin{slide}{Importing a public key}
...
\begin{slide}{Listing key signatures}
...
\begin{slide}[toc=]{Public key servers}
  \begin{itemize}
...
\makeatletter\renewcommand{\verbatim@font}{\scriptsize\tt}\makeatother
\begin{slide}{Encrypting a document}
  \begin{itemize}
...
\begin{slide}{Decrypting a document}
  \begin{itemize}
...
\begin{slide}{Symmetric encryption}
  \begin{itemize}
...
\makeatletter\renewcommand{\verbatim@font}{\tiny\tt}\makeatother
\begin{slide}{Clearsigned documents}
  \begin{itemize}
...
\begin{slide}{Detached signatures}
  \begin{itemize}
...
\begin{slide}{Verifying signatures}
  \begin{itemize}
