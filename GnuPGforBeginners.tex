...
\begin{slide}[method=direct,toc=]{Generating a new keypair}
  \begin{itemize}
  \item Finally, you must enter a passphrase to protect your private key.
  \end{itemize}
\begin{verbatim}
...
\begin{slide}[method=direct]{Signing a key}
  ...
  \item Ideally you should also tell GnuPG how carefully you have
    verified that they key you are signing really belongs to who you
    think it does.
  \end{itemize}
\end{slide}
...
\begin{slide}{Using trust to validate keys}
  \begin{itemize}
  \item Formerly, a key was considered valid only if you verified and signed it
    personally.
